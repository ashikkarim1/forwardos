...
export const metadata: Metadata = pageMetadata({
  title: 'Business Brokers in the USA, Canada & the UAE — Verified Directory',
  description: 'Find a verified business broker in the USA, Canada or the UAE. Browse advisors by region, industry, and language (EN/FR/AR), read verified-deal reviews, or join as a broker to list businesses.',
  path: '/business-brokers',
  keywords: ['business brokers', 'business broker', 'M&A advisors', 'business brokers USA', 'business brokers Canada', 'business brokers UAE', 'business brokers Dubai', 'sell business through broker', 'become a business broker'],
})
...
const faqs = [
  ...
  { q: 'Can brokers list multiple businesses?', a: 'Yes. Brokers can join Forward to list and manage multiple businesses, reach verified buyers across the USA, Canada and the UAE, and build a reviewed public profile.' },
]
