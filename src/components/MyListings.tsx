...
const STATUS_LABEL: Record<string, { label: string; color: string; bg: string }> = {
  ...
  CLOSED:    { label: 'Sold',        color: '#1D4ED8', bg: '#EFF6FF' },
      ...
      <div className="flex items-start gap-4 flex-wrap">
        <div className="flex-1 min-w-[200px]">
          <div className="flex items-center gap-2 flex-wrap mb-1.5">
            ...
            {deal.enquiryCount > 0 && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold tracking-wide uppercase" style={{ color: '#1D4ED8', background: '#EFF6FF' }}>
